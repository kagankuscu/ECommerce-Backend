    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAddressRel", x => new { x.AppUserId, x.AddressId });
                    table.ForeignKey(
                        name: "FK_UserAddressRel_Address_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAddressRel_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "PromotionProductCategoryRel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionProductCategoryRel", x => new { x.PromotionId, x.ProductCategoryId });
                    table.ForeignKey(
                        name: "FK_PromotionProductCategoryRel_ProductCategories_ProductCategoryId",
                        column: x => x.ProductCategoryId,
                        principalTable: "ProductCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionProductCategoryRel_Promotions_PromotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopOrders_Address_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopOrders_UserPaymentMethods_UserPaymentMethodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VariationOption_Variations_VariationId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductItemVariationOptionRel",
                columns: table => new
                {
                    ProductItemId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductItemVariationOptionRel", x => new { x.ProductItemId, x.VariationOptionId });
                    table.ForeignKey(
                        name: "FK_ProductItemVariationOptionRel_ProductItems_ProductItemId",
                        column: x => x.ProductItemId,
                        principalTable: "ProductItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductItemVariationOptionRel_VariationOption_VariationOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItemVariationOptionRel_VariationOptionId",
                table: "ProductItemVariationOptionRel",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionProductCategoryRel_ProductCategoryId",
                table: "PromotionProductCategoryRel",
                column: "ProductCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopOrders_UserPaymentMethodId",
                table: "ShopOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAddressRel_AddressId",
